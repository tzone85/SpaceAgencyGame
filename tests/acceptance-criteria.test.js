...
describe('Story 01KKVMGT-s-001 - Project Setup & Directory Structure', () => {
  ...
  describe('Acceptance Criteria 4: All files from project structure exist as empty placeholders with basic exports/comments', () => {
    const requiredFiles = [
      ...
      { path: 'src/core/renderer.js', shouldContain: ['class Renderer', 'export'] },
      { path: 'src/entities/index.js', shouldContain: ['export', 'EntityManager'] },
      { path: 'src/systems/index.js', shouldContain: ['export', 'SystemManager'] },
      { path: 'src/scenes/index.js', shouldContain: ['export', 'SceneManager'] },
      ...
      { path: 'public/manifest.json', shouldContain: ['Stellar Command', 'name'] },
